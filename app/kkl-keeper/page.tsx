      ...
      <>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <Trophy style={{ width: '48px', height: '48px', margin: '0 auto 1rem', color: '#b19cd9' }} className="animate-pulse" />
            <p style={{ color: '#b19cd9', fontSize: '1.2rem' }}>Loading KKL keeper data...</p>
          </div>
        </div>
      </>
    );
    ...
    return (
      <>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <AlertCircle style={{ width: '48px', height: '48px', margin: '0 auto 1rem', color: '#ff6b6b' }} />
            <p style={{ color: '#ff6b6b', fontSize: '1.2rem' }}>{error || 'No KKL player data available'}</p>
          </div>
        </div>
      </>
    );
